...
const RegisterScreen_1 = require("@/features/auth/components/RegisterScreen");
        ...
        <div className="flex-1 flex flex-col justify-center items-center px-6 sm:px-12 md:px-24 py-12">
          <div className="w-full max-w-md space-y-6">
            ...
            <div className="flex items-center gap-8 border-b border-border mb-6">
              <link_1.default href="/login" className="pb-3 text-lg font-medium text-muted-foreground hover:text-foreground transition-colors">
                Đăng nhập
              </link_1.default>
            ...
            <RegisterScreen_1.RegisterScreen />
            ...
            <p className="text-center text-sm text-muted-foreground pt-4">
              Đã có tài khoản? <link_1.default href="/login" className="font-bold text-primary hover:text-primary/80 transition-colors">Đăng nhập ngay</link_1.default>
            </p>
