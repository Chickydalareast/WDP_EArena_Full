...
function HeroSection() {
    return (<section className="relative pt-32 pb-20 lg:pt-40 lg:pb-24 overflow-hidden transition-colors duration-200">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
              <button_1.Button asChild size="lg" className="h-14 px-8 text-lg font-bold rounded-xl shadow-lg shadow-primary/25 hover:-translate-y-1 transition-transform">
