...
exports.TeacherDashboardSidebar = TeacherDashboardSidebar;
...
function TeacherDashboardSidebar() {
    return (<aside className="w-full flex flex-col gap-6">
      ...
      <div className="bg-card rounded-xl shadow-sm border border-border p-5">
        ...
        <div className="space-y-3">
          {MENU_ITEMS.map((item, index) => (<link_1.default key={index} href={item.href} className="w-full flex items-center gap-3 p-3 rounded-lg border border-border hover:border-primary/30 hover:bg-primary/5 transition-all group bg-muted/30">
...
//# sourceMappingURL=TeacherDashboardSidebar.js.map