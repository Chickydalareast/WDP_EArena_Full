...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            jwt_1.JwtModule.registerAsync({
                ...
                useFactory: (configService) => ({
                    secret: configService.get('JWT_ACCESS_SECRET') || 'fallback_secret',
                    signOptions: {
                        expiresIn: `${configService.get('JWT_ACCESS_EXPIRATION_MINUTES') || 15}m`,
                    },
                }),
            }),
        ...
        providers: [auth_service_1.AuthService, jwt_strategy_1.JwtStrategy, token_repository_1.TokenRepository, auth_cache_repository_1.AuthCacheRepository],
