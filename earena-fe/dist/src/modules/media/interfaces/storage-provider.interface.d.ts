...
export declare const CLOUDINARY_PROVIDER = "CLOUDINARY_PROVIDER";
export declare const VIDEO_PROVIDER = "VIDEO_PROVIDER";
...
export interface IVideoProvider extends ITicketStorageProvider {
    createResumableUploadSession(fileMetadata: any): Promise<{
        uploadUrl: string;
        fileId: string;
    }>;
