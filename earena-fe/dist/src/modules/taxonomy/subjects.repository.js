...
let SubjectsRepository = SubjectsRepository_1 = class SubjectsRepository extends abstract_repository_1.AbstractRepository {
    logger = new common_1.Logger(SubjectsRepository_1.name);
    constructor(model, connection) {
        super(model, connection);
    }
};
exports.SubjectsRepository = SubjectsRepository;
exports.SubjectsRepository = SubjectsRepository = SubjectsRepository_1 = __decorate([
