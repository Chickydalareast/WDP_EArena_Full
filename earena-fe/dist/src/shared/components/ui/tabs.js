...
function TabsList({ className, variant = "default", ...props }) {
    return (<radix_ui_1.Tabs.List data-slot="tabs-list" data-variant={variant} className={(0, utils_1.cn)(tabsListVariants({ variant }), className)} {...props}/>);
}
