        ...
        <div className="flex-1 flex flex-col justify-center items-center px-6 sm:px-12 md:px-24 py-12">
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="flex items-center gap-8 border-b border-border">
              ...
              <Link href="/register" className="pb-3 text-lg font-medium text-muted-foreground hover:text-foreground transition-colors">
                Đăng ký
              </Link>
            </div>
            ...
            <p className="text-center text-sm text-muted-foreground pt-4">
              Bạn chưa có tài khoản? <Link href="/register" className="font-bold text-primary hover:text-primary/80 transition-colors">Đăng ký ngay</Link>
            </p>
