...
import { StudentFooter } from "@/shared/components/layout/StudentFooter"; 
...
export default function StudentLayout({
  ...
  return (
    <div className="bg-background text-foreground antialiased min-h-screen flex flex-col transition-colors duration-200">
      ...
      <main className="flex-1 pt-24 pb-12 max-w-[1600px] mx-auto w-full px-4 sm:px-6 lg:px-8 flex flex-col gap-8">
        {children}
      </main>
