export default function AnalyticsSection() {
  return (
    <section className="py-20 bg-card border-y border-border transition-colors duration-200">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="col-span-1 bg-background p-6 rounded-2xl shadow-sm border border-border flex flex-col items-center hover:shadow-md transition-shadow">
              ...
              <div className="relative w-48 h-48 flex items-center justify-center">
                ...
                {/* Hình đa giác Radar (Dùng inline style thay cho class .radar-shape để module hóa 100%) */}
                <div 
                  className="w-full h-full bg-primary/20 absolute transition-all duration-700 ease-in-out hover:bg-primary/30"
            ...
            {/* Cột 2: Badge Thành tích & Tiến độ */}
            <div className="col-span-1 flex flex-col gap-6">
              {/* Badge Top 1 (Giữ nguyên gradient rực rỡ) */}
