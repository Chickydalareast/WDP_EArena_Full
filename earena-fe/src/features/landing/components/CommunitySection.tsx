...
export default function CommunitySection() {
  return (
    <section className="py-20 bg-background overflow-hidden transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          
          {/* Cột Trái (hoặc đổi thứ tự trên Mobile): Nội dung text */}
          <div className="order-2 lg:order-1">
            ...
            <Link href="/register" className="inline-flex items-center text-primary font-bold hover:underline decoration-2 underline-offset-4 transition-all">
              Tham gia diễn đàn ngay <span className="material-symbols-outlined ml-1">arrow_right_alt</span>
            </Link>
          </div>

          {/* Cột Phải: Mockup Diễn đàn (Cards xếp chồng) */}
          <div className="order-1 lg:order-2 relative">
            ...
            <div className="space-y-4 relative z-10">
              ...
              {/* Card Comment 1 (Nổi bần bật phía trước) */}
              ...
              {/* Card Comment 2 (Chìm phía sau, scale nhỏ lại xíu) */}
