...
export default function FeaturedClasses() {
  return (
    <section className="py-16 bg-card border-t border-border transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-end mb-10">
          ...
          <Link 
            href="/classes" 
            className="hidden sm:flex items-center text-primary font-semibold hover:text-primary/80 transition"
          >
              ...
              <div className="px-6 pb-6 relative flex-1 flex flex-col">
                <div className="flex justify-between items-end -mt-8 mb-4">
                  ...
                  <div className="relative">
                    {/* Tạm dùng img thuần tránh lỗi next/image config */}
                    <img 
                      alt="Teacher" 
                      className="w-16 h-16 rounded-full border-4 border-background object-cover bg-background" 
