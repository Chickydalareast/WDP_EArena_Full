...
import { QuestionSyncAction, QuestionSyncJobData } from '../questions/interfaces/question.interface';
    ...
    async process(job: Job<QuestionSyncJobData>): Promise<void> {
        ...
        try {
            ...
            if (action === QuestionSyncAction.DELETE) {
                ...
                const paperAnswers = (question.answers || []).map((a: any) => ({ id: a.id, content: a.content }));
