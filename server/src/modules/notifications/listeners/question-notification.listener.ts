...
import { NotificationType, NotificationEventPattern } from '../constants/notification-event.constant';
...
export class QuestionNotificationListener {
    ...
    @OnEvent(NotificationEventPattern.QUESTION_AUTO_TAG_BATCH_COMPLETED, { async: true })
